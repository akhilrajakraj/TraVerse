...
def parse_structured_output(*, raw_text: str, schema: Type[SchemaType], repair_callback: Callable[[str], str]) -> SchemaType:
    ...
    try:
        ...
        repair_prompt = (
            "Return ONLY one valid JSON object that validates against the exact schema below. "
            "Do not return Markdown, comments, explanations, trailing commas, or additional fields. "
            "Preserve valid information and repair truncated strings, missing quotes, commas, braces, "
            "or other JSON syntax errors.\n\n"
