...
class GroqClient:
    ...
    - timeout handling
    - retry/backoff
    - JSON response mode for structured calls
    ...
    def _call_raw(
        ...
        *,
        ...
        """Shared low-level Groq request used by all AI calls."""
        kwargs = {
        ...
        if json_mode:
            # The planner prompts already require JSON. JSON Object Mode makes
            # that contract provider-enforced instead of prompt-only.
    ...
    def call(
        ...
        *,
        ...
        """Public interface used by structured and conversational agents."""
        try:
