...
class PackingItemSchema(BaseModel):
    """
    A single packing list item generated by the AI.
    """

    category: str = Field(
        ...,
        pattern=(
            r"^(clothing|electronics|documents|toiletries|"
            r"medication|accessories|miscellaneous)$"
        ),
        description="Packing item category.",
    )
    ...
    item: str = Field(
        ...
        min_length=1,
        max_length=100,
        description="Name of the packing item.",
    )
    ...
    reason: str = Field(
        ...
        min_length=3,
        max_length=300,
        description="Reason why this item is recommended.",
    )


class PackingListSchema(BaseModel):
    """
    Complete AI-generated packing list.
    """

    items: list[PackingItemSchema] = Field(
        default_factory=list,
        description="Packing list items.",
    )