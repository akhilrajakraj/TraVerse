...
from ai.prompts.chat_agent_v1 import ChatAgentPromptV1, chat_agent_prompt_v1


class ChatAgent:
    """Handles conversational interactions with the user."""

    def __init__(self, *, client: GroqClient | None = None, prompt: ChatAgentPromptV1 | None = None) -> None:
        self._client = client or GroqClient()
        self._prompt = prompt or chat_agent_prompt_v1

    def reply(self, *, conversation_context: str, user_message: str, retrieved_destinations=None) -> str:
